...
import { HttpClient } from "microsoft/signalr/src/HttpClient";
import { MessageHeaders } from "microsoft/signalr/src/IHubProtocol";
import { ILogger, LogLevel } from "microsoft/signalr/src/ILogger";
import { HttpTransportType, ITransport } from "microsoft/signalr/src/ITransport";
import { EventSourceConstructor, WebSocketConstructor } from "microsoft/signalr/src/Polyfills";
